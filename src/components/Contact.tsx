      ...
      <div className="content-item">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          <div style={{ display: 'flex', gap: '1rem', alignItems: 'baseline' }}>
            <span className="content-meta" style={{ width: '80px', margin: 0 }}>Resume</span>
            <a href="/assets/resume.pdf" target="_blank" rel="noreferrer" style={{ fontWeight: 500, textDecoration: 'underline', textDecorationColor: 'transparent', transition: 'text-decoration-color 0.2s' }} onMouseOver={(e) => e.currentTarget.style.textDecorationColor = 'currentColor'} onMouseOut={(e) => e.currentTarget.style.textDecorationColor = 'transparent'}>View Resume ↗</a>
          </div>
